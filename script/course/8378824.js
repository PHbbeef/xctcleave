$.get("http://127.0.0.1/api", function(data) {
    ...
    document.getElementById("time1-1").innerHTML = data.time1;  // 发起申请时间
    ...
    document.getElementById("time4").innerHTML = data.number + "," + data.college  + "-" + data.teacher + "," + data.classes + ",3号公寓楼-315-1"+ " 销假" + "（" + `${month}` + "月" + `${day}` + "日的事假）";
    //计算请假天数
    ...
    function Eliminate1(){
    if (Eliminate == "true"){
        document.getElementById("leave_permit").style.display = "block";
